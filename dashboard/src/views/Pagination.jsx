        ...
        for (let i = startPage; i < endPage; i++) {
            btns.push(
                <li onClick={() => setPageNumber(i)} className={`
                    ${pageNumber === i ? 'bg-green-500 shadow-lg shadow-green-500/50 text-white' : 'bg-slate-700 hover:bg-green-500 shadow-lg hover:shadow-green-500/50 hover:text-white text-[#d0d2d6]'} w-[33px] h-[33px] rounded-full flex justify-center items-center cursor-pointer`
                }>
                    {i}
                </li>
            )
