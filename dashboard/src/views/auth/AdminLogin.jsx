...
import logo from "../../assets/logo.png"; // Adjust the path based on your component's location
...
const AdminLogin = () => {
  ...
  // Hardcoded security pin
  const SECURITY_PIN = "1234";

  const [state, setState] = useState({
    email: "",
    password: "",
    pin: "", // Added security pin
  });
  ...
  const submit = (e) => {
    ...
    if (state.pin !== SECURITY_PIN) {
      toast.error("Invalid Security Pin!");
      return;
    }

    dispatch(admin_login({ email: state.email, password: state.password }));
  };
